	...
	<div id="wrapper" class="clearfix">
		...
		<header id="header" class="page-section full-header">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.php" class="standard-logo" data-dark-logo="images/logo-dark.png"><img src="images/logo/BITE.png" alt="Canvas Logo"></a>
						<a href="index.php" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img src="images/logo/BITE.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
					...
					<nav id="primary-menu" class="one-page-menu">
						...
						<ul>
							...
							<li class="mega-menu"><a href="#" data-href="#servicios"><div>Servicios</div></a></li>

							<li class="mega-menu"><a href="#" data-href="#portafolio"><div>Portafolio</div></a></li>

							<li class="mega-menu"><a href="#" data-href="#equipo"><div>Equipo</div></a></li>

							<li class="mega-menu"><a href="#" data-href="#contactanos"><div>Contáctanos</div></a></li>
						</ul>
		...
		<section id="content">
			...
			<div class="content-wrap">
				...
				<section id="portafolio" class="page-section topmargin-lg">
				...
				<section id="equipo" class="page-section topmargin-lg">
						...
						<div class="col_half">
							...
							<div class="contact-widget">
								...
								<div class="col_two_third">
									<label for="template-contactform-subject">Descripción <small>*</small></label>
						...
						<div class="col_full nobottommargin clearfix">
							...
							<div class="col_one_fourth">
								<div class="feature-box fbox-center fbox-bg fbox-plain">
									...
									<h3>Nuestra Sede<span class="subtitle">San Martin de Porres, Lima</span></h3>
								</div>
							</div>
							...
							<div class="col_one_fourth">
								<div class="feature-box fbox-center fbox-bg fbox-plain">
									...
									<h3>Llámanos<span class="subtitle">(+51) 01 575 2849</span></h3>
								</div>
							</div>
							...
							<div class="col_one_fourth">
								<div class="feature-box fbox-center fbox-bg fbox-plain">
									...
									<h3>Video Llamada<span class="subtitle">BITEconsulting</span></h3>
								</div>
							</div>
